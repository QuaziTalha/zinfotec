          ...
          <div class="col-lg-6">
            <div class="single-product-details">
              <div class="single-product-title">
                <h2>PVC Panels & Decorative Walls</h2>
              ...
              <p class="single-product-desc" style="text-align: justify;">
                <b>PVC Panels & Decorative Walls:</b><br/>

                Introducing our range of Decorative PVC Wall Panels, designed to elevate the aesthetics of residential and commercial spaces. With their multicolored design and high-quality PVC material, these panels offer a perfect combination of functionality and visual appeal.
              ...
              <div class="product-description">
                ...
                <ul class="content-feature-list style2 list-style mb-0">
                    <li>
                        ...
                        <b>Design:</b><br/>
                         Our Decorative Wall Panels feature eye-catching designs that add a touch of elegance and sophistication to any interior. Transform your space with unique patterns and textures that suit your style preferences.
                      </li>
                      <li>
                        <i class="flaticon-checkbox"></i>
                        <b> Color: </b><br/>
                       Enjoy the versatility of multicolor options, allowing you to select the perfect combination that complements your existing decor or creates a striking focal point in your space.
                      </li>
                      <li>
                        <i class="flaticon-checkbox"></i>
                        <b>Usage/Application:</b><br/>
                         Ideal for both residential and commercial settings, these PVC wall panels are suitable for various applications, including homes, offices, restaurants, hotels, retail spaces, and more. Add a touch of style to any room or environment.
                      </li>
                      <li>
                        <i class="flaticon-checkbox"></i>
                        <b> Material:</b><br/>
                        Crafted from high-quality PVC, our wall panels offer durability and long-lasting performance. PVC is known for its resistance to abrasion and wear, ensuring that your panels retain their aesthetic appeal over time.
                      </li>
                ...
                <div class="desc-title">
                  ...
                  <ul class="content-feature-list style2 list-style mb-0">
                      <li>
                          <i class="flaticon-checkbox"></i>
                          <b>Aesthetic Design:</b><br/>
                           The decorative patterns and textures of our PVC wall panels create a visually appealing and stylish atmosphere in any space.
                        </li>
                        <li>
                          <i class="flaticon-checkbox"></i>
                          <b>Smooth Finish:</b><br/>
                           The panels are meticulously crafted to deliver a smooth and flawless finish, adding a touch of sophistication to your walls.
                        </li>
                        <li>
                          <i class="flaticon-checkbox"></i>
                          <b>Lightweight:</b><br/>
                           Despite their sturdy construction, our PVC wall panels are lightweight, making installation easy and convenient.
                        </li>
                        <li>
                          <i class="flaticon-checkbox"></i>
                          <b>Abrasion-Resistant:</b><br/>
                         The panels are designed to withstand everyday wear and tear, ensuring their longevity and maintaining their attractive appearance.
                        </li>
                        <li>
                          <i class="flaticon-checkbox"></i>
                          <b>High Material Strength:</b><br/>
                           Built with quality PVC material, our wall panels offer excellent strength and durability, providing a long-lasting solution for your interior design needs.
                        </li>
